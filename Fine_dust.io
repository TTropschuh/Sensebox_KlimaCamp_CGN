...
// senseBox ID
const char SENSEBOX_ID[] PROGMEM = "60c9e5da48c4b3001b9c9d08";
...
// sensor IDs
// Temperatur
const char TEMPERSENSOR_ID[] PROGMEM = "60c9e5da48c4b3001b9c9d0c";
// rel. Luftfeuchte
const char RELLUFSENSOR_ID[] PROGMEM = "60c9e5da48c4b3001b9c9d0b";
// PM10
const char PM10SENSOR_ID[] PROGMEM = "60c9e5da48c4b3001b9c9d0a";
// PM2.5
const char PM25SENSOR_ID[] PROGMEM = "60c9e5da48c4b3001b9c9d09";
...
void submitValues() {
  ...
  for (uint8_t timeout = 2; timeout != 0; timeout--) {
    ...
    if (connected == true) {
      ...
      sprintf_P(buffer,
                PSTR("POST /boxes/%s/data HTTP/1.1\nAuthorization: 55b094d7177683d639eb8ed77c9b36cd635a2e7e62248bc0ae5f9950767a50df\nHost: %s\nContent-Type: "
                     "text/csv\nConnection: close\nContent-Length: %i\n\n"),
